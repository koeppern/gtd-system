#!/usr/bin/env python3
"""
Script to disable RLS on GTD tables using direct database connection
"""
import asyncio
import sys
import os
...
async def disable_rls_direct():
    """Disable RLS on all GTD tables using direct asyncpg connection"""
    ...
    print("🔧 Disabling RLS on GTD Tables (direct asyncpg)")
    print("=" * 50)
    ...
    try:
        ...
        if success_count > 0:
            ...
            print("   Use the enable_rls_direct.py script to re-enable RLS.")
